...
/**
 * p6spy를 이용한 log를 커스터마이징하기 위한 formatter 클래스
...
public class P6spySqlFormatter implements MessageFormattingStrategy {
    ...
    public String formatMessage(final int connectionId, final String now, final long elapsed, final String category,
        ...
        for (int i = 0; i < stackTrace.length; i++) {
            ...
            if (trace.startsWith("io.p6spy") && !trace.contains("P6spySqlFormatter")) {
    ...
    // formatMessage 메소드를 출력할 때 사용하는 메소드. 출력할 SQL 전략을 선택
